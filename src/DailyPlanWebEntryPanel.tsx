...
type Props={user:User;selectedDate?:string;onDateChange?:(date:string)=>void;onSaved?:()=>void}
...
function DraftActionIcon({name}:{name:DraftActionIconName}){
...
export default function DailyPlanWebEntryPanel({user,selectedDate,onDateChange,onSaved}:Props){
