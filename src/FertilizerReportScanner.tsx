...
export type FertilizerScanResult={date:string;shift:string;mandor:string;assistant:string;units:ScanUnit[];rawText:string;confidence:number;warnings:string[];sourceModel?:string;learningFeedbackSaved?:boolean;learningChangedFields?:number}
