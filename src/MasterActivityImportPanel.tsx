...
type ActivityBase={description:string;activity:string;type:string;activityCategory:string;sourceRow:number;occurrence:number}
...
function parseWorkbook(buffer:ArrayBuffer,fileName:string,scope:string,codes:ExistingCodeMap):ParsedFile{
  ...
  validationRows.forEach((row,index)=>{
    ...
    activityBases.push({description,activity,type,activityCategory,sourceRow,occurrence})
  })
...
export default function MasterActivityImportPanel({user,onOpenManage}:Props){
  ...
  return <section>
    ...
    <div className="panel form-stack">
      ...
      <p className="muted">File wajib berisi sheet <strong>List Validasi</strong>, <strong>Master Activity</strong>, dan <strong>Bahan</strong>. Activity tanpa komposisi bahan/dosis otomatis menjadi INACTIVE. Duplikat nama/deskripsi hanya menjadi WARNING agar import data besar tidak terblokir; perbaikannya dilakukan setelah import melalui Review Pasca Import.</p>
