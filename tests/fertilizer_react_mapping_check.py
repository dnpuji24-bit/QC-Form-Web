...
required_form_tokens = [
    ...
    "uploaded?'finalizeRecord':'syncRecord'",'num(f.jumlah)/num(f.hasilKerja)','averageActualDosage','weightedActualDosage','Rata-rata Dosis Aktual','Dosis Total/Ha','Simpan Koreksi Uploaded','PhotoPicker','unit-tab-rail','activeCardId','Tambah Unit','HOLD • ISSUE / DOWNTIME'
]
